...
**
** Created: Tue Dec 17 18:04:12 2013
...
static const char qt_meta_stringdata_FrameRate[] = {
    "FrameRate\0"
};
...
const QMetaObjectExtraData FrameRate::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FrameRate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FrameRate,
      qt_meta_data_FrameRate, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FrameRate::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FrameRate))
        return static_cast<void*>(const_cast< FrameRate*>(this));
    if (!strcmp(_clname, "EffectInterface"))
        return static_cast< EffectInterface*>(const_cast< FrameRate*>(this));
